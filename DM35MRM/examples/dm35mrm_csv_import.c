/**
    ...
    @brief
        This program demonstrates how to use the CSV Import function. Can be used
		by a script.
...
int main(int argument_count, char **arguments)
{
	...
	if (filename[0] == '\0') help_option_given = OPTION_GIVEN;
	...
	// Disable the Auto Latching to have very Simultaneous
	// Setting of the Relays
	DM35MRM_GC_Auto_Latch_Disable(&relay_info);

	result = DM35MRM_Set_Relays_With_CSV_Import(&relay_info,filename);
	printf("CSV RESULT: %d\r\n",result);

	// Make sure to re-enable the Auto Latching behaviour
	// as it is assumed in other programs.
