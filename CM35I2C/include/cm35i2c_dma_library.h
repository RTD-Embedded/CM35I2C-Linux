/**
    ...
    @brief
        Definitions for the CM35I2C DMA Library.

    $Id: cm35i2c_dma_library.h 105018 2016-12-07 15:47:31Z rgroner $
*/
...
#ifndef __CM35I2C_DMA_LIBRARY_H__
#define __CM35I2C_DMA_LIBRARY_H__
...
Public library constants
 ...
 /**
  * @defgroup CM35I2C_Dma_Library_Constants CM35I2C DMA Public Library Constants
  * @{
 */
 ...
 *    to clear it.
 */
#define CM35I2C_DMA_BUFFER_STATUS_CLEAR		0x00
 ...
 */
#define CM35I2C_DMA_BUFFER_CTRL_HALT		0x02
 ...
 */
#define CM35I2C_DMA_BUFFER_CTRL_LOOP		0x04
 ...
 */
#define CM35I2C_DMA_BUFFER_CTRL_INTR		0x08
 ...
 *    after processing this buffer.
 */
#define CM35I2C_DMA_BUFFER_CTRL_PAUSE		0x10

/**
 * @brief
 *    Constant value indicating DMA control block size.
 */
#define CM35I2C_DMA_CTRL_BLOCK_SIZE		0x10

/**
 * @brief
 *    Constant value indicating DMA buffer control block size.
 */
#define CM35I2C_DMA_BUFFER_CTRL_BLOCK_SIZE	0x10
 ...
 *    a 32-bit register.
 */
#define CM35I2C_BIT_MASK_DMA_BUFFER_SIZE	0x0FFFFFF

 /**
  * @brief
  *    Descriptions of the possible states the FIFO might be in.
  */
enum CM35I2C_Fifo_States {

	/**
	 * State of FIFO is unknown.
	 */
	CM35I2C_FIFO_UNKNOWN,
	 ...
	 */
	CM35I2C_FIFO_HAS_DATA
};

/**
 * @} CM35I2C_Dma_Library_Constants
 */
...
Public library functions
 ...
 /**
  * @defgroup CM35I2C_Dma_Library_Functions CM35I2C DMA Public Library Functions
  * @{
 */
...
CM35I2CLIB_API
int
CM35I2C_Dma_Start(struct CM35I2C_Board_Descriptor *handle,
...
CM35I2CLIB_API
int
CM35I2C_Dma_Stop(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel);
...
CM35I2CLIB_API
int
CM35I2C_Dma_Pause(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel);
...
CM35I2CLIB_API
int
CM35I2C_Dma_Clear(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel);
 ...
 */
CM35I2CLIB_API
int CM35I2C_Dma_Get_Fifo_Counts(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel,
 ...
 */
CM35I2CLIB_API
int CM35I2C_Dma_Get_Fifo_State(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel,
				enum CM35I2C_Fifo_States *state);
 ...
 */
CM35I2CLIB_API
int CM35I2C_Dma_Configure_Interrupts(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel,
				int enable,
				int error_enable);
 ...
 */
CM35I2CLIB_API
int CM35I2C_Dma_Get_Interrupt_Configuration(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel,
				int *enable,
				int *error_enable);
 ...
 */
CM35I2CLIB_API
int CM35I2C_Dma_Setup(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel,
				int direction,
				int ignore_used);
 ...
 */
CM35I2CLIB_API
int CM35I2C_Dma_Setup_Set_Direction(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel,
				int direction);
 ...
 */
CM35I2CLIB_API
int CM35I2C_Dma_Setup_Set_Used(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel,
				int ignore_used);
 ...
 */
CM35I2CLIB_API
int CM35I2C_Dma_Get_Errors(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel,
				int *stat_overflow,
				int *stat_underflow,
 ...
 */
CM35I2CLIB_API
int CM35I2C_Dma_Status(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel,
 ...
 */
CM35I2CLIB_API
int CM35I2C_Dma_Get_Current_Buffer_Count(struct CM35I2C_Board_Descriptor *handle,
					const struct CM35I2C_Function_Block *func_block,
					unsigned int channel,
					uint32_t *current_buffer,
					uint32_t *current_count);
 ...
 */
CM35I2CLIB_API
int CM35I2C_Dma_Check_For_Error(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel,
				int *has_error);
 ...
 */
CM35I2CLIB_API
int CM35I2C_Dma_Buffer_Setup(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel,
				unsigned int buffer,
				uint8_t ctrl);
 ...
 */
CM35I2CLIB_API
int CM35I2C_Dma_Buffer_Status(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel,
				unsigned int buffer,
				uint8_t *status,
...
CM35I2CLIB_API
int CM35I2C_Dma_Check_Buffer_Used(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel,
 ...
 */
int
CM35I2C_Dma_Find_Interrupt(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int *channel,
 ...
 */
int
CM35I2C_Dma_Clear_Interrupt(struct CM35I2C_Board_Descriptor *handle,
					const struct CM35I2C_Function_Block *func_block,
					unsigned int channel,
					int clear_overflow,
					int clear_underflow,
 ...
 */
int
CM35I2C_Dma_Reset_Buffer(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel,
				unsigned int buffer);
...
CM35I2CLIB_API
int CM35I2C_Dma_Buffer_Get_Size(struct CM35I2C_Board_Descriptor *handle,
					const struct CM35I2C_Function_Block *func_block,
					unsigned int channel,
					unsigned int buffer,
...
int CM35I2C_Dma_Buffer_Set_Size(struct CM35I2C_Board_Descriptor *handle,
				const struct CM35I2C_Function_Block *func_block,
				unsigned int channel,
				unsigned int buffer,
				uint32_t buffer_size);
