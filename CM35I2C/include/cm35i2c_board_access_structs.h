/**
    ...
    @brief
        Structures for the CM35I2C Board Access Library.

    $Id: cm35i2c_board_access_structs.h 80523 2014-07-17 18:38:59Z rgroner $
*/
...
#ifndef _CM35I2C_BOARD_ACCESS_STRUCTS__H_
#define _CM35I2C_BOARD_ACCESS_STRUCTS__H_


/**
 * @defgroup CM35I2C_PCI_Region_Structures CM35I2C PCI Region Structures
 * @{
 */
...
enum cm35i2c_pci_region_access_size {

	/**
	 * 8-bit access
	 */

	CM35I2C_PCI_REGION_ACCESS_8 = 0,

	/**
	 * 16-bit access
	 */

	CM35I2C_PCI_REGION_ACCESS_16,

	/**
	 * 32-bit access
	 */

	CM35I2C_PCI_REGION_ACCESS_32,
 ...
 */
enum CM35I2C_DMA_FUNCTIONS {

	/**
	 * Initialize the DMA buffers
	 */
	CM35I2C_DMA_INITIALIZE,
...
struct cm35i2c_pci_access_request {

	/**
	 * Size of access in bits
	 */

	enum cm35i2c_pci_region_access_size size;

	/**
	 * The PCI region to access
	 */

	enum cm35i2c_pci_region_num region;
...
struct cm35i2c_ioctl_region_readwrite {

	/**
	 * PCI region access request
	 */

	struct cm35i2c_pci_access_request access;
};
...
struct cm35i2c_ioctl_region_modify {
...
struct cm35i2c_ioctl_interrupt_info_request {
 ...
 */
struct cm35i2c_ioctl_dma {

	/**
	 * Requested DMA function to perform.
	 */
	enum CM35I2C_DMA_FUNCTIONS function;
	 ...
	 */
	struct cm35i2c_pci_access_request pci;
...
union cm35i2c_ioctl_argument {
	...
	struct cm35i2c_ioctl_region_readwrite readwrite;

	/**
	 * PCI region read/modify/write
	 */

	struct cm35i2c_ioctl_region_modify modify;

	/**
	 * Interrupt request structure
	 */

	struct cm35i2c_ioctl_interrupt_info_request interrupt;
	/**
...
/**
 * @} CM35I2C_Board_Access_Structures
 */
