/**
    ...
    @brief
        Defines for the CM35I2C Example programs.  Commonly used constants
        for the example programs included with the software package.


    $Id: cm35i2c_examples.h 114740 2018-07-12 14:41:17Z prucz $
*/
...
#ifndef __CM35I2C_EXAMPLES_H__
#define __CM35I2C_EXAMPLES_H__

 /**
  * @defgroup CM35I2C_Example_Constants CM35I2C Example Programs Constants
  * @{
  */
