/**
    ...
    @brief
        Defines for the CM35I2C.  Values for the general board, not specific
        to a particular function block.

    $Id: cm35i2c_types.h 149930 2025-09-25 18:44:06Z bkorpacz $
*/
...
#ifndef __CM35I2C_TYPES_H__
#define __CM35I2C_TYPES_H__

/**
 * @defgroup CM35I2C_General_Definitions CM35I2C Board Types
 * @{
 */
 ...
 */
#define CM35I2C_SUBTYPE_00	0

/**
 * @brief
 *     Constant for FB subtype 1
 */
#define CM35I2C_SUBTYPE_01	1

/**
 * @brief
 *     Constant for FB subtype 2
 */
#define CM35I2C_SUBTYPE_02	2

/**
 * @brief
 *     Constant for FB subtype 3
 */
#define CM35I2C_SUBTYPE_03	3
 ...
 */
#define CM35I2C_DMA_MAX_BUFFER_SIZE			0xFFFFFC
 ...
 */
#define CM35I2C_BOARD_ACK_INTERRUPT	0x1

/**
 * @brief
 *      Value to write to the Reset register in order to reset the board.
 */
#define CM35I2C_BOARD_RESET_VALUE	0xAA
 ...
 *      read/write access.
 */
#define CM35I2C_FIFO_ACCESS_FB_REVISION 0x01

/**
 * @} CM35I2C_General_Definitions
 */
