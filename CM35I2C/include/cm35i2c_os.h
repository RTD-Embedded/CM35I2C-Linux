/**
    ...
    @brief
        Function declarations for the CM35I2C that are Linux specific.

    $Id: cm35i2c_os.h 154351 2026-05-14 12:16:17Z asutton $
*/
...
#ifndef _CM35I2C_BOARD_OS__H_
#define _CM35I2C_BOARD_OS__H_
...
/**
 * @defgroup CM35I2C_Board_Access_Library CM35I2C Board Access Public Library Functions
 * @{
 */

/**
  @brief
  CM35I2C board descriptor.  This structure holds information about
  the board as a whole.  It holds the file descriptor and ISR callback
  function, if applicable.
 */

struct CM35I2C_Board_Descriptor {
	 ...
	 */
	void (*isr) (struct cm35i2c_ioctl_interrupt_info_request info_req);
 ...
 */
int
CM35I2C_Dma_Initialize(struct CM35I2C_Board_Descriptor *handle,
 ...
 */
	int CM35I2C_General_SetISRPriority(struct CM35I2C_Board_Descriptor
					   *handle, int priority);

/**
 * @} CM35I2C_Board_Access_Library
 */
